          ...
          <div class="container">
            <div class="about-content">
              ...
              <a href="#" class="btn btn-primary">
                <span class="text text-1">Conocer más</span>

                <span class="text text-2" aria-hidden="true">Conocer más</span>
              </a>
            </div>
      ...
      -->
        ...
        <section class="section menu" aria-label="menu-label" id="menu">
          <div class="container">
            ...
            <h2 class="headline-1 section-title text-center">Delicioso menú</h2>
        ...
        <section
          ...
          <div class="container">
            ...
            <p class="headline-2 testi-text">
              Quería darte las gracias por invitarme a esa increíble cena la
          ...
          <div class="container">
            <div class="form reservation-form bg-black-10">
              ...
              <div
                ...
                ">
                <h2 class="headline-1 text-center">Contáctanos</h2>
                ...
                <div class="event-card has-before hover:shine">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="card-title title-2 text-center">
                      Sabor tan bueno que intentarás comerlo con tus ojos
                    </h3>
                  </div>
                </div>
              </li>
